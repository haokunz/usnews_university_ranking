...
# 定义计算赋分的函数
def calculate_scores(df, score_col_name, rank_norm_func, offer_norm_func, acceptance_norm_func, offer_col_name):
    # 对排名进行归一化
...
# 计算原始录取人数情况下的赋分
df_original_linear_log = calculate_scores(df.copy(), 'Original_Linear_Log', linear_normalize, log_normalize, log_normalize, 'offer_重复次数')
df_original_log_log = calculate_scores(df.copy(), 'Original_Log_Log', log_normalize, log_normalize, log_normalize, 'offer_重复次数')

# 计算均值_30_53情况下的赋分
df_mean_30_53_linear_log = calculate_scores(df.copy(), '均值_30_53_Linear_Log', linear_normalize, log_normalize, log_normalize, '录取人数_均值_30_53')
df_mean_30_53_log_log = calculate_scores(df.copy(), '均值_30_53_Log_Log', log_normalize, log_normalize, log_normalize, '录取人数_均值_30_53')

# 计算均值_20_53情况下的赋分
df_mean_20_53_linear_log = calculate_scores(df.copy(), '均值_20_53_Linear_Log', linear_normalize, log_normalize, log_normalize, '录取人数_均值_20_53')
df_mean_20_53_log_log = calculate_scores(df.copy(), '均值_20_53_Log_Log', log_normalize, log_normalize, log_normalize, '录取人数_均值_20_53')


# 保存最终结果到Excel
with pd.ExcelWriter("///大学排名计算/final_ranking_with_two_normalization_2.xlsx") as writer:
